<template>
  ...
  >
    <div class="better-scroll-content">
      <div
        ref="listWrapper"
        class="better-scroll-list-wrapper"
      >
        <slot>
          <ul class="better-scroll-list">
            <li
              class="better-scroll-item border-bottom-1px"
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              v-show="!isPullingDown"
              class="cube-pulldown-loaded"
            ><span>{{ refreshTxt }}</span></div>
          </div>
        </div>
      </slot>
    </div>
...
import { getRect, camelize } from "@/common/utils";

const COMPONENT_NAME = "better-scroll";
